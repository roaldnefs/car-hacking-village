...
Landing page for the **Car Hacking Village** at [BSides Groningen](https://bsidesgroningen.nl/) — a hands-on workshop where attendees inject CAN frames into a bench-mounted VW Group instrument cluster (Škoda Fabia, SEAT Ibiza, SEAT Leon, ~2010) using a USB-to-CAN badge (CANable 2.0 / SH-C31A) driven entirely in the browser via **WebUSB**.
